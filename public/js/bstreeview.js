...
; (function ($, window, document, undefined) {
    ...
    var templates = {
        ...
        treeviewItem: '<div role="treeitem" class="list-group-item py-1" data-toggle="collapse"></div>',
    ...
    $.extend(bstreeView.prototype, {
        ...
        build: function (parentElement, nodes, depth) {
            ...
            $.each(nodes, function addNodes(id, node) {
                ...
                if(node.nodes){
                    var treeItemStateIcon="&emsp;<span class=\"badge badge-light badge-pill\">"+node.nodes.length+"</span>";
                    treeItem.append(treeItemStateIcon);
                }
                // Build child nodes.
                if (node.nodes) {
